...
function callWeather(city,state,rowNumber){
  ...
  document.getElementById('searchButton').clickEvent = true
...
appController.controller('myAppController',['$scope','$http',function($scope,$http) {
 ...
 $scope.globalCall = function(street,city,state){
  ...
  $scope.updateSearchFlag =  function(){
    ...
    if(!document.getElementById("searchButton").disabled && document.getElementById('searchButton').clickEvent){
         document.getElementById('searchResult').style.display="block";
       }
    document.getElementById('favourite').style.display="none";
 ...
 $scope.changeText = function(){
  ...
  $scope.weatherSearch = function() {
    ...
    mainData.then(function(data){
      ...
      var url = "https://newproject-1573689447678.appspot.com/ReverseGeocode?lat=+"+data['lat']+"&lon="+data['lon']
  ...
  $scope.globalSearch = function(street,city,state){
    ...
    for (var i = 0; i< cityComponent.length;i++){
     ...
     var url = "https://newproject-1573689447678.appspot.com/Geocode?address="+address
  ...
  $scope.currentWeather = function(data,timezone){
    ...
    console.log("current data = "+mainState);
    console.log(data);
    state="CA";
    ...
    //var url = "http://localhost:8080/StateSeal?state="+mainState
